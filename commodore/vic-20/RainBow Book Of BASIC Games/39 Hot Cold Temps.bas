100 REM TEMPS
110 GOSUB 1100
120 LET X=0:LET Y=2:GOSUB 1700
130 PRINT "{space*4}temperature":PRINT:PRINT"{space*4}conversions"
140 PRINT:PRINT "a = centigrade to":PRINT:PRINT "{space*4}fahrenheit"
150 PRINT:PRINT "b = fahrenheit to":PRINT:PRINT "{space*4}centigrade"
160 PRINT:PRINT "press{space*2}a{space*2}or{space*2}b"
170 GOSUB 1500:IF G$<>"a" AND G$<>"b" THEN GOTO 170
180 GOSUB 2800:IF G$="b" THEN GOTO 240
190 LET Y=4:GOSUB 1700:PRINT "centigrade : ";
200 GOSUB 2100:LET C=K
210 LET F=INT(C*1.8+32.5)
220 PRINT:PRINT "fahrenheit : ";F
230 GOTO 280
240 LET Y=4:GOSUB 1700:PRINT "fahrenheit : ";
250 GOSUB 2100:LET F=K
260 LET C=INT(5*(F-32)/9+0.5)
270 PRINT:PRINT "centigrade : ";C
280 PRINT:PRINT:STOP
