...
150 LET M=2*M
160 NEXT F
170 LET M1=INT(M/100):LET M2=M-10*INT(M/10)
180 LET N2=N-10*INT(N/10)
190 IF M1=5 AND M3=N2 OR M1=9 AND M3=M2 THEN PRINT N;" ";M
200 IF M>999 THEN PRINT:PRINT:STOP
210 NEXT N
