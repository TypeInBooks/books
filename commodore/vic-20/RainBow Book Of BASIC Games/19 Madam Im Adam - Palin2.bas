100 REM PALIN2
110 GOSUB 1100
120 LET L1=10:LET L2=100
130 LET Q=4
140 LET X=0:LET Y=6:GOSUB 1700:PRINT"testing ";Q
150 LET N=Q*Q
160 IF N<L1 THEN GOTO 200
170 IF N>=L2 THEN LET L1=100*L1:LET L2=100*L2:GOTO 200
180 GOSUB 220
190 IF T=1 THEN PRINT:PRINT"number = ";Q:PRINT:PRINT"square = ";N:PRINT:STOP
200 LET Q=Q+1
210 GOTO 140
220 REM TEST PALINDROME
230 LET A=N
240 LET B=0
250 LET A1=INT(A/10)
260 LET B=10*B+A-10*A1
270 LET A=A1
280 IF A>0 THEN GOTO 250
290 LET T=0
300 IF B=N THEN LET T=1
310 RETURN
