100 REM AGE
110 GOSUB 1100
120 FOR A=11 TO 99 STEP 2
130 LET N=A
140 LET X=0:LET Y=2:GOSUB 1700:PRINT "age being tested ";A
150 GOSUB 250
160 IF T=1 THEN GOTO 230
170 LET N=1980-A
180 GOSUB 250
190 IF T=1 THEN GOTO 230
200 LET A1=INT(A/10)
210 LET N1=N-10*INT(N/10)
220 IF A1=N1 THEN PRINT"age = ";A:PRINT"year of birth = ";N:GOSUB 1500
230 NEXT A
240 PRINT:PRINT:STOP
250 REM TEST FOR PRIME
260 LET T=0
270 FOR Q=3 TO SQR(N) STEP 2
280 LET R=N/Q
290 IF R=INT(R) THEN LET T=1:LET Q=SQR(N)
300 NEXT Q
310 RETURN
