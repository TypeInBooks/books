100 REM INTEREST
110 GOSUB 1100
120 LET X=0:LET Y=D/2:GOSUB 1700
130 PRINT "simple and compound":PRINT:PRINT "{space*5}interest"
140 LET T=3:GOSUB 1400:GOSUB 2800
150 LET X=0:LET Y=2:GOSUB 1700:PRINT "size of loan? ";:GOSUB 2100:LET L=K
160 PRINT:PRINT "interest(%)? ";:GOSUB 2100:LET I=K
170 PRINT:PRINT "time in years ";:GOSUB 2100:LET Y=K
180 LET R=INT(L+L*I*Y/100+0.5)
190 PRINT:PRINT "amount to repay is"
200 PRINT:PRINT ;R;" (simple)"
210 LET R=L:FOR N=1 TO Y:LET R=R*(1+I/100):NEXT N
220 LET R=INT(R+0.5)
230 PRINT:PRINT ;R;" (compound)"
240 PRINT:STOP
